...
test('web profile keeps the original balance bundle and uses the pinned DingTalk status seam', async () => {
  ...
  assert.equal(profile.dependencies['@local/dsh-dingtalk-subscriptions'], 'link:/Users/marcus/.dsh/extensions/dsh-dingtalk-subscriptions')
  ...
  assert.ok(profile.dsh.profile.bundles.includes('@local/dsh-dingtalk-subscriptions'))
  assert.ok(profile.dsh.profile.bundles.indexOf('@local/dsh-dingtalk-subscriptions') < profile.dsh.profile.bundles.indexOf('@dingtalk-real-ai/dsh-dingtalk'))
  ...
  assert.match(runtimePatch, /AccountManager/)
  assert.match(runtimePatch, /onRobotAccountsChanged/)
  assert.match(runtimePatch, /brand-pending/)
  assert.match(runtimePatch, /accessProfile/)
  assert.match(runtimePatch, /resolveRuntimePolicy/)
  assert.match(runtimePatch, /exactShrimpMatch/)
  assert.match(runtimePatch, /subscriberOptionSnapshots/)
  assert.match(runtimePatch, /subscriber tool gate denied/)
  assert.match(runtimePatch, /beginQuotaLease/)
  assert.match(runtimePatch, /recordQuotaUsage/)
  assert.match(runtimePatch, /finalizeQuotaLease/)
  assert.match(runtimePatch, /authorizeShrimpInvocation/)
  assert.match(runtimePatch, /classifyProtectedContentRequest/)
  assert.match(runtimePatch, /guardModelOutput/)
  assert.match(runtimePatch, /tokenUsageRequired/)
  assert.match(runtimePatch, /subscriber token usage unavailable/)
  assert.match(runtimePatch, /requireUsage/)
  assert.match(runtimePatch, /waitForUsage/)
