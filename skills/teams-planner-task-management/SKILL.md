...
description: Review and manage Microsoft Planner tasks from Teams workflows. Use
  when the user wants to inspect plans or buckets, create tasks from follow-ups,
  update task fields, or safely delete a Planner task.
compatibility: Ported from Codex plugin teams
