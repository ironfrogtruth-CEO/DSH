...
| 部署级别 | 需要内容 | 能力 |
| --- | --- | --- |
| 轻量单包 | `html编辑器skill/` | 可生成和编辑 HTML，可使用精简售前知识与精选素材。 |
| 完整生产包 | `html编辑器skill/` + `知识库/` + `素材库/` | 可生成和编辑 HTML，并具备完整知识真相、真源追溯和全量素材替换能力。 |
...
- 默认使用相对路径：`resources/pingan-materials`。
